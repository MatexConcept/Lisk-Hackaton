                ...
                <div className="new_flex">
                  <div className="swiper-slide">
                    <div className="crumina-module crumina-pricing-table pricing-table--small">
                      ...
                      <a className="btn btn--large btn--dark-lighter btn--transparent full-width">Buy Bitcoin Now!</a>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="crumina-module crumina-pricing-table pricing-table--small">
                      ...
                      <a className="btn btn--large btn--dark-lighter btn--transparent full-width">Buy Ethereum Now!</a>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="crumina-module crumina-pricing-table pricing-table--small">
                      ...
                      <a className="btn btn--large btn--dark-lighter btn--transparent full-width">Buy Dash Now!</a>
                    </div>
                  </div>
